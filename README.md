...
The initial goal of the project is to create a forward compiler that is on par with BYOND's compiler in regards to error detection, lexical analysis and logical parsing.
